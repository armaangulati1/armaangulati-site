...
metrics:
  ...
  - value: "9/9"
    label: "X12 835 denial-triage exact-match"
    qualifier: "1.000 precision/recall per class on its 9-claim self-authored fixture set; invented denial-code system, synthetic data"
  - value: "6/6"
    label: "HL7 v2 ingestion exact-match"
    qualifier: "self-authored synthetic HL7 v2 set; ingestion fidelity, not real-world interoperability"
  - value: "310 / 337"
    label: "Tests passing (CI-gated / total)"
    qualifier: "310 CI-gated (excludes network, ocr, browser marks); 337 total including those"
links:
...
tldr:
  ...
  - "Speaks the formats payers and hospitals use: X12 278 and 835 EDI plus an HL7 v2 ingestion layer, and takes a real phone call through a signature-validated Twilio voice agent"
